...
namespace v2rayN.Forms
{
    public partial class MainForm : BaseForm
    {
        ...
        private void InitServersView()
        {
            ...
            lvServers.Columns.Add("", 20, HorizontalAlignment.Center);
            lvServers.Columns.Add(UIRes.I18N("LvServiceType"), 70, HorizontalAlignment.Left);
            lvServers.Columns.Add(UIRes.I18N("LvAlias"), 160, HorizontalAlignment.Left);
            ...
            lvServers.Columns.Add(UIRes.I18N("LvEncryptionMethod"), 70, HorizontalAlignment.Left);
            lvServers.Columns.Add(UIRes.I18N("LvTransportProtocol"), 70, HorizontalAlignment.Left);
            lvServers.Columns.Add(UIRes.I18N("LvSubscription"), 70, HorizontalAlignment.Left);
            lvServers.Columns.Add(UIRes.I18N("LvTestResults"), 90, HorizontalAlignment.Left);
        ...
        string msg = string.Format(UIRes.I18N("RestartService"));
